...
class CreateProfileSucessScreen extends StatefulWidget {
  const CreateProfileSucessScreen({super.key});

  @override
  State<CreateProfileSucessScreen> createState() => _CreateProfileSucessScreenState();
}

class _CreateProfileSucessScreenState extends State<CreateProfileSucessScreen> {
  @override
